...
import { AllCommunityModule, colorSchemeDarkBlue, colorSchemeDarkWarm, colorSchemeLightCold, colorSchemeLightWarm, ModuleRegistry, themeQuartz } from "ag-grid-community";
...
export class CustomerInfoComponent implements OnInit {
  ...
  apiurl = 'http://localhost:5000/customers/Post';
 ...
 constructor(private sqlApiService: SqlApiService) { }
  ...
  ngOnInit(): void {
    this.sqlApiService.getCustomersFromApi(this.apiurl).subscribe((customers) => {
