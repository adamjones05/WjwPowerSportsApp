...
import { AllCommunityModule, ColDef, colorSchemeDarkBlue, colorSchemeLightCold, ModuleRegistry, themeQuartz } from 'ag-grid-community';
...
export class EditCustomerComponent implements OnInit {
 ...
 loadCustomerById() {
  const foundCustomer = this.data.find(c => c.customerId === +this.customer.customerId);
